...
class NoticeCreateDto {
    data class Request(
        ...
        @Schema(description = "사용 여부", requiredMode = Schema.RequiredMode.REQUIRED) val useFlag: Boolean,
    ) {
        fun toEntity(operator: Operator): Notice = Notice.of(title, content, useFlag, operator)
    }
}
